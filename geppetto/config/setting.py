...
config.read(get_env_variable("conf", ("%s/config.ini" % (BASE_DIR+"/conf"))))

log_config = configparser.RawConfigParser()
log_config.read(get_env_variable("log", ("%s/log.ini" % (BASE_DIR+"/conf"))))
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'interval': 1,
            'backupCount': 5,
            'filename': BASE_DIR+log_config['Default']['filename'],
            'formatter': 'standard'
        },
    },
    'loggers': {
